...
<head>
    ...
    <meta name="description" content="Bienal">
    <meta name="viewport" content="Bienal Ajans">
    ...
    <div class="collapse navbar-collapse positon-fixed" id="navbarText">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
                <a class="nav-link" href="#page1"><div class="d-flex align-items-center"><img src="./assets/images/manu-icon.png" class="mr-2 nav-one"><span>ANASAYFA</span></div></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#page2"><div class="d-flex align-items-center"><img src="./assets/images/manu-icon.png" class="mr-2 nav-two"><span>HAKKIMIZDA</span></div></a>
            </li>
        </ul>
        <div class="logo-container d-none d-lg-flex">
            <div class="logo"><a href="#page1"><img src="./assets/images/logolar/ust-logo.svg"></a></div>
        </div>
        <ul class="navbar-nav ml-auto">
            <li class="nav-item">
                <a class="nav-link" href="#page4"><div class="d-flex align-items-center"><img src="./assets/images/manu-icon.png" class="mr-2 nav-three"><span>VİDEOLAR</span></div></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#page5"><div class="d-flex align-items-center"><img src="./assets/images/manu-icon.png" class="mr-2 nav-four"><span>İŞ ORTAKLARI</span></div></a>
            </li>
        </ul>
    </div>
</nav>
...
<div id="page1">
    <div class="container">
        <div class="sc-logo d-flex d-lg-none"><img src="./assets/images/logolar/ust-logo.svg"></div>
...
<div id="page2" class="page position-relative">
    <div class="cont-custon position-relatice page">
        <div class="page-2-content bg-Fdark m-auto d-flex align-items-center">
            <div class="slogan-title"><?php echo $printed['description_tr']; ?></div>
        </div>
        <div class="left-side">
            ...
            <div class="vertical-text we-are-text d-none d-md-flex">Biz</div>
            ...
            <div class="wwp-title-wrapper d-flex d-lg-block align-items-center">
                ...
                <div class="position-relative title-ancation-wrapper">
                    ...
                    <div class="title-animation">
                        <div class="wwp-title vertical-text">HAKKIMIZDA</div>
                        <div class="wwp-title vertical-text">HAKKIMIZDA</div>
                    </div>
                </div>
